...
def render_pin_result():
	try:
		...
		mongo.db.events.insert_one( {"Name": title_result, "Type": etype_result, "Date": month_result+" "+day_result+","+year_result, "Time": time_result + " " + ampm_result, "Location": location_result})
