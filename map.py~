...
def render_map():		
		...
		return render_template('map.html', l1_result = l1, l2_result = l2, title_result = title, time_result = time, date_result = date, etype_result = etype, location_result = location)
